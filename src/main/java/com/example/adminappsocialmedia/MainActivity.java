...
public class MainActivity extends AppCompatActivity {
    ...
    FirebaseAuth mauth;
    TextView tvsingout,showreport,showreportusers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showreportusers = findViewById(R.id.showreportUsers);
        ...
        showreportusers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(MainActivity.this, ReportUsers.class);
